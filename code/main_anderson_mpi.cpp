...
/*!
 \brief Main 
 \param \*argv[] ./cbemd nsteps dt temperature xml_file bond_file output_file
 */
int main (int argc, char *argv[]) {
	...
	if (argc != 7) {
		fprintf(stderr, "syntax: ./cbemd nsteps dt xml_file energy_file output_file temperature \n");
