...
void slj (Atom *a1, Atom *a2, const vector <double> *box);						//!< Computes force and energy
void fene (Atom *a1, Atom *a2, const vector <double> *box);						//!< Computes force and energy
void harmonic (Atom *a1, Atom *a2, const vector <double> *box);					//!< Computes force and energy
...
private:
	double Ushift_, rcut2_;							//!< Note that rcut is stored as a square so that checking will be faster
	force_ptr my_force_;
