...
\item 
int \hyperlink{read__interaction_8cpp_aac5c3aa8175670e7097069c3ca90f45c}{read\-\_\-interactions} (const string filename, \hyperlink{classsim__system_1_1System}{System} $\ast$sys)
...
\begin{DoxyCompactList}\small\item\em Given a name, return the force\-\_\-energy\-\_\-ptr associated with it. Also check the arguments that will be passed to it are in acceptable range. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
Given a name, return the force\-\_\-energy\-\_\-ptr associated with it. Also check the arguments that will be passed to it are in acceptable range. 
